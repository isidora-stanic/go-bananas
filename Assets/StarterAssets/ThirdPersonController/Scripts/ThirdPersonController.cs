...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        // AIM - so we can disable rotation while moving so that a character can move correctly in the aim mode
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                if (_rotateOnMove) // this condition is added for manipulating aim mode
                {
